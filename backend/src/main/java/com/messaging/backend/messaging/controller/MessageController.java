...
public class MessageController {
    ...
    public ResponseEntity<SuccessResponse<PageResponse<MessageResponse>>> getMessages(
            @AuthenticationPrincipal AuthenticatedUser authenticatedUser,
            @PathVariable String conversationId,
        ...
        return ResponseEntity.ok(SuccessResponse.success("Messages retrieved successfully", PageResponse.of(responsePage)));
    }
