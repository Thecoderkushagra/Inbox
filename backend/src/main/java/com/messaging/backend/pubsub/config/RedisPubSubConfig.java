...
public class RedisPubSubConfig {
    ...
    /**
     * Configures the message listener adapter with a String serializer and target listener method.
     */
    @Bean
    public MessageListenerAdapter messageListenerAdapter(RedisEventListener redisEventListener) {
